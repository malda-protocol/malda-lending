...
/// @notice Interface for mERC20 token host operations
interface ImErc20 {
    ...
    /// @return repaymentAmount The actual amount repaid
    ...
    /// @notice The sender liquidates the borrowers collateral and transfers seized assets to the liquidator
