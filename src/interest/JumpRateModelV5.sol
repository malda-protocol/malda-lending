...
/**
 * @title JumpRateModelV5
 * @notice Implementation of the IInterestRateModel interface for calculating interest rates
 */
contract JumpRateModelV5 is IInterestRateModel, Ownable {
    // ----------- STORAGE ------------

    error JumpRateModelV5_MultiplierNotValid();
    error JumpRateModelV5_InputNotValid();
