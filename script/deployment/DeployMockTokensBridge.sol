...
contract DeployMockTokensBridge is Script {
    ...
    function run() public returns (address) {
        ...
        bytes32 salt = 0xd3a4fb9515de1ecef26ba26461a94109c92b489b2ef734c979b6029589463e13;
        ...
        if (created.code.length == 0) {
            ...
            created = _deployer.create(salt, abi.encodePacked(type(MockTokensBridge).creationCode, abi.encode(roles, tokens)));
            vm.stopBroadcast();
