...
contract DeployProtocolRelease is DeployBaseRelease {
    ...
    function setUp() public override {
        ...
        feeds.push(
            OracleFeed({
                symbol: "mUSDC",
                defaultFeed: 0x874b4573B30629F696653EE101528C7426FFFb6b,
                toSymbol: "USD",
        ...
        feeds.push(
            OracleFeed({
                symbol: "mWETH",
                defaultFeed: 0x2284eC83978Fe21A0E667298d9110bbeaED5E9B4,
                toSymbol: "USD",
        ...
        feeds.push(
            OracleFeed({
                symbol: "mUSDT",
                defaultFeed: 0x0c547EC8B69F50d023D52391b8cB82020c46b848,
                toSymbol: "USD",
                underlyingDecimals: 6
            })
        );
        ...
        feeds.push(
            OracleFeed({
                symbol: "mWBTC",
                defaultFeed: 0xa34Aa6654A7E45fB000F130453Ba967Fd57851C1,
                toSymbol: "USD",
        ...
        feeds.push(
            OracleFeed({
                symbol: "mwstETH",
                defaultFeed: 0x043F8c576154E19E05cD53b21Baab86deC75c728,
                toSymbol: "USD",
                underlyingDecimals: 18
            })
        );
        ...
        feeds.push(
            OracleFeed({
                symbol: "mezETH",
                defaultFeed: 0x01600fE800B9a1c3638F24c1408F2d177133074C,
                toSymbol: "USD",
                underlyingDecimals: 18
            })
        );
        ...
        feeds.push(
            OracleFeed({
                symbol: "mweETH",
                defaultFeed: 0x6Bd45e0f0adaAE6481f2B4F3b867911BF5f8321b,
                toSymbol: "USD",
                underlyingDecimals: 18
            })
        );
        ...
        feeds.push(
            OracleFeed({
                symbol: "mwrsETH",
                defaultFeed: 0xB7b25D8e8490a138c854426e7000C7E114C2DebF,
                toSymbol: "USD",
                underlyingDecimals: 18
            })
        );
    ...
    function _deployAndConfigRebalancerAndBridges(string memory network, address rolesContract) internal {
        ...
        address rebalancer = deployRebalancer.run(rolesContract, owner, owner, deployer);
