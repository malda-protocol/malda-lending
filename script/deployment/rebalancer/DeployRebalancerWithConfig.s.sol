...
contract DeployRebalancerWithConfig is Script {
    function run() public {
        ...
        bridgeTokens[0] = Rebalancer.BridgeTokens({bridge: 0xB77358f17b588a20Dc8A0529b7d5658eA7328c33, tokens: tokens});
        bridgeTokens[1] = Rebalancer.BridgeTokens({bridge: 0x0D6C5079CdCdC7d84104F0598EBFAd943dc5281e, tokens: tokens});
        ...
        bytes memory creationCode =
            abi.encodePacked(type(Rebalancer).creationCode, abi.encode(roles, saveAddress, admin, initData));
        console.log("========================================");
        ...
        console.logBytes(abi.encodeWithSelector(deployer.create.selector, salt, creationCode));
        console.log("========================================");
    }
