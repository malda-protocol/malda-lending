...
contract SetMinBorrowSize is Script {
    ...
    //     sizes[0] = 10e6;                  // 10 USDC (6 decimals)
    //     sizes[1] = 10e6;                  // 10 USDT (6 decimals)
    //     sizes[2] = 2380950000000000;      // ~0.00238 ETH
    //     sizes[3] = 9090;                  // ~0.0000909 BTC (8 decimals)
    //     sizes[4] = 2380950000000000;      // ~0.00238 wstETH
    //     sizes[5] = 2380950000000000;      // ~0.00238 ezETH
    //     sizes[6] = 2380950000000000;      // ~0.00238 weETH
    //     sizes[7] = 2380950000000000;      // ~0.00238 wrsETH
