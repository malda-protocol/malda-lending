...
/// @title DeployEverclearBridgeV2
/// @author Merge Layers Inc.
/// @notice Single deployment script that deploys EverclearBridgeV2
contract DeployEverclearBridgeV2 is DeploymentScriptBase {
    ////////////////////////////////////////////////////////////
    //                        Structs                         //
    ////////////////////////////////////////////////////////////
    ...
    function _deployAndAssertResult(bytes memory deployConfig) internal override returns (address bridgeAddress) {
        ...
        if (bridgeAddress.code.length == 0) {
            bytes memory callData = abi.encodeWithSelector(
                ...
                salt,
                abi.encodePacked(type(EverclearBridgeV2).creationCode, abi.encode(cfg.roles, cfg.feeAdapter))
            );
        ...
        EverclearBridgeV2 bridge = EverclearBridgeV2(bridgeAddress);
