...
# src
  ...
  - [❱ libraries](src/libraries/README.md)
    ...
    - [IHypernativeFirewall](src/libraries/HypernativeFirewallProtected.sol/interface.IHypernativeFirewall.md)
    - [HypernativeFirewallProtected](src/libraries/HypernativeFirewallProtected.sol/abstract.HypernativeFirewallProtected.md)
