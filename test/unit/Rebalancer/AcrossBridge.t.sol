...
import {MockAcrossSpokePool, MockMarket, MockRebalancer} from "test/mocks/rebalancer/AcrossBridgeMocks.t.sol";
...
contract AcrossBridgeTest is BaseTest {
    ...
    function test_fuzz_sendMsg_success(uint256 inputAmount, uint256 outputAmount) external {
        ...
        inputAmount = bound(inputAmount, 1, type(uint256).max / 10_000);
